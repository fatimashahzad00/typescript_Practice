...
//   tube = ball;// Error
// Property 'length' is missing in type 'Ball' but required in type 'Tube'.
ball = tube;
...
// Case 2a
// myType = { id: 3, name_tom: "Mike"}; //Case 2a: Error, renamed or missing property
//Object literal may only specify known properties, and 'name_tom' does not exist in type '{ name: string; id: number; }'.
...
x = { id: 2, fullname: "Zia"}; // Ok, `fullname` matched by index signature


// Case 3
// myType = { id: 2, name: "Tom", age: 20}; //Case 3: Error, excess property
